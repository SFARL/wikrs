...
| 发布流程（版本策略、预检、机械步骤、翻车处理） | [RELEASING.md](RELEASING.md) |
...
| 3 | [stages/stage-3-llm-output.md](stages/stage-3-llm-output.md) | AST → sections JSONL / Markdown，LLM 管线取向（HTML 方案已否决，[留档](stages/stage-3-html.md)） |
